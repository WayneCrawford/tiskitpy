...
from rptransient import TimeSpans, EQRemover, rotate_clean
...
class TestMethods(unittest.TestCase):
    ...
    def test_eq_remover(self):
        """
        Test EQRemover object.
        """
        eqr = EQRemover(UTCDateTime(2011, 11, 1),
                       UTCDateTime(2011, 11, 2), quiet=True)
        self.assertEqual(str(eqr), "EQRemover("
                                   "start_time=UTCDateTime(2011, 11, 1, 0, 0), "
                                   "end_time=UTCDateTime(2011, 11, 2, 0, 0), "
                                   "min_magnitude=5.85, "
        ...
        self.assertEqual(
            eqr.spans,
            TimeSpans([UTCDateTime(2011, 10, 28, 18, 54, 34, 40000),
                       UTCDateTime(2011, 11, 1, 12, 32, 0, 430000)],
                      [UTCDateTime(2011, 10, 30, 8, 42, 34, 40000),
                       UTCDateTime(2011, 11, 2, 4, 44, 0, 430000)]))
