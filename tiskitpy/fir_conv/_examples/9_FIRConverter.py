...
FIR_file = '../fir_coeffs/lc2000_fir3_linear.json'
FIR_file = '../fir_coeffs/TI_ADS128x_FIR4-linear.json'
# FIR_file = '../fir_coeffs/TI_ADS128x_FIR4-minphase.json'
# Create a converter from a zero-phase FIR file
converter = FIRConverter.from_zeros_file(FIR_file, 0)

# Plot technical figures about the input FIR
print('Plotting Z-plane representation of the input filter')
converter.plot_zplane()
print('Plotting Z-plane representation of the equivalent filter')
converter.plot_output_zplane()
