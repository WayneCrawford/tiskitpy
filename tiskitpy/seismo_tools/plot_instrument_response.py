...
def main():
    ...
    plt.figure(1)
    _plot_instrument_response(channel, SEED_id, arguments)
    plt.savefig(outf_base + "_instrument_response.png")
...
def _plot_instrument_response(channel, seed_id, args):
    """Plot instrument response"""
    ...
    if args.plot_each_stage:
        ...
        for stage in rng:
            r, f = resp.get_evalresp_response(
                t_samp, nfft, start_stage=stage, end_stage=stage
            )
